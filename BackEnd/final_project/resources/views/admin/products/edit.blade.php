@push('scripts')
    ...
    <script>
        ...
        let myDropzone = new Dropzone("#dropzone", {
            ...
            {{--            let img = `<input type="hidden" name="album[]" value="${file.path}" />`--}}
                    ...
                    <div class="tab-pane fade show active" id="basic_Data" role="tabpanel">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-5">
                                ...
                                <input type="text" name="ar_name" class="form-control" value="{{ $product->ar_name }}" placeholder="Arabic Name"/>
                            </div>

                            <div class="col-lg-6 mb-5">
                                <label class="form-label">English Name</label>
                                <input type="text" name="en_name" class="form-control" value="{{ $product->en_name }}" placeholder="English Name"/>
                            </div>
                            ...
                            <div class="col-lg-4 mb-5">
                                ...
                                <select class="form-select" name="category_id"  data-control="select2" data-placeholder="Select Category">
                                    <option></option>
                            ...
                            <div class="col-lg-6 mb-5">
                                ...
                                <textarea name="en_smalldesc" class="form-control" rows="4" placeholder="English Small Description">{{ $product->en_smalldesc }}
                                </textarea>
                            </div>

                            <div class="col-lg-6 mb-5">
                                <label class="form-label">Arabic Small Description</label>
                                <textarea name="ar_smalldesc" class="form-control" rows="4" placeholder="Arabic Small Description">{{ $product->ar_smalldesc }}</textarea>
                            </div>

                            <div class="col-lg-6 mb-5">
                                <label class="form-label">English Description</label>
                                <textarea name="en_desc" class="form-control description" placeholder="English Small Description">{!! $product->en_desc !!}</textarea>
                            </div>

                            <div class="col-lg-6 mb-5">
                                <label class="form-label">Arabic Description</label>
                                <textarea name="ar_desc" class="form-control description" placeholder="Arabic Small Description">{!! $product->ar_desc !!}</textarea>
                            </div>


                            <div class="col-12 mb-5">
                                <div class="form-check form-check-custom form-check-success form-check-solid">
                                    <input class="form-check-input" id="featured" value="1" name="featured" @checked($product->featured) type="checkbox" />
                        ...
                        <div class="row">
                            <div class="col-12 mb-5">
                                ...
                                <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url({{ asset('./assets/images/default-image.png') }})">
                                    ...
                                    <div class="image-input-wrapper w-100px h-100px" style="background-image: url({{ asset($product->image->path) }})"></div>
...
{{--                                @dd($product->variations)--}}
                                ...
                                <div class="color-wrap">
                                    <div class="row mb-2">
                                        <div class="col-lg-8 mb-3 mb-lg-0">
                                            <input type="text" name="variation[colors][0][value]" class="form-control" value="" placeholder="Value"/>
                                        </div>
                                        <div class="col-lg-4 mb-3 mb-lg-0">
...
{{--    <input type="hidden" class="images_ads" name="album[]"  value="{{ $gall['path'] }}">--}}
{{--    @endforeach--}}
