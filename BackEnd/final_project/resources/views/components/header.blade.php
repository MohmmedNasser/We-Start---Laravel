            ...
            <div class="d-flex align-items-center overflow-auto pt-3 pt-lg-0">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex">
                        ...
                        <a href="#" class="btn  btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px w-md-40px h-md-40px" data-kt-menu-trigger="{default:'click', lg: 'click'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen060.svg-->

                            <div class="d-flex justify-content-center">
                                <div class="symbol symbol-20px">
                                    @if(app()->getLocale() == 'ar')
                                        <img src="{{ asset('./assets/media/flags/saudi-arabia.svg') }}" alt="" class="img-fluid">
                                    @else
                                        <img src="{{ asset('./assets/media/flags/united-states.svg') }}" alt="" class="img-fluid">
                                    @endif
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-color fw-semibold py-4 fs-base w-150px" data-kt-menu="true" data-kt-element="theme-mode-menu">
                            ...
                            @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                <div class="menu-item px-3 my-0">
                                    <a hreflang="{{ $localeCode }}"  href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}" class="menu-link px-3 py-2">
                                        @if($localeCode == 'ar')
                        ...
                        <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                            ...
                            <div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-start">
                                <img src="{{ asset(Auth::user()->image ? Auth::user()->imageUrl : './assets/images/default-image.png') }}" alt="user">
                            </div>
...
{{--                                            <img alt="Logo" src="{{ asset(Auth::user()->image ? Auth::user()->image->path : ' ./assets/images/default-image.png')  }}">--}}

                                            <img alt="Logo" src="{{ Auth::user()->imageUrl }}">
                                ...
                                <div class="menu-item px-5">
                                    <a href="{{ route('admin.profile.edit') }}" class="menu-link px-5">الملف الشخصي</a>
                                </div>
                                <!--end::Menu item-->

                                <!--begin::Menu item-->
                                <div class="menu-item px-5">
                                    <a href="{{ route('admin.settings') }}" class="menu-link px-5">الاعدادت</a>
                                </div>
                                <!--end::Menu item-->
