            ...
            <div class="grid grid-cols-3 gap-6">
                <div v-for="product in products" :key="product.id" class="bg-white shadow rounded overflow-hidden group">
                    ...
                    <button @click.prevent="addToCart(product.id)"
                        class="flex justify-center items-center w-full py-2 text-center text-white bg-primary border border-primary rounded-b hover:bg-transparent hover:text-primary transition relative">
                        <span>
                            Add to cart
                        </span>
                    </button>
